  ...
  (0, _createClass3.default)(Market, [{
    ...
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
        var txReceipt, market, collateralTokenIstance, playTokenIstance, txResponse, web3;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                collateralTokenIstance = this._configInstance.gnosisJS.contracts.Token.at(this._configInstance.collateralToken);
              ...
              case 5:
                ...
                playTokenIstance = (0, _tokens.getPlayMoneyTokenInstance)(this._configInstance);
                _context2.next = 9;
                return playTokenIstance.allowTransfers([this._marketInfo.marketAddress, this._marketInfo.eventAddress]);

              case 9:
                _context2.next = 11;
                return collateralTokenIstance.approve(this._marketAddress, this._marketInfo.funding);
