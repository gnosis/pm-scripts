...
*/
var isMarketResolved = function () {
  var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8(marketDescription, configInstance) {
    var market, marketResolved, event, eventResolved, oracle, oracleResolved;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            (0, _log.logInfo)('Check if market ' + marketDescription.marketAddress + ' was already resolved...');
            market = new _markets2.default(marketDescription, configInstance);
            _context8.next = 5;
            return market.isResolved();

          case 5:
            marketResolved = _context8.sent;
            event = void 0;

            if (marketDescription.outcomeType === 'SCALAR') {
              event = new _scalarEvent2.default(marketDescription, configInstance);
            } else {
              event = new _categoricalEvent2.default(marketDescription, configInstance);
            }
          ...
          case 10:
            eventResolved = _context8.sent;
            oracle = new _centralizedOracle2.default(marketDescription, configInstance);
            _context8.next = 14;
            return oracle.isResolved();

          case 14:
            oracleResolved = _context8.sent;
            return _context8.abrupt('return', marketResolved && eventResolved && oracleResolved);
  ...
  return function isMarketResolved(_x14, _x15) {
...
* Returns True if market resolved, False otherwise
*/
var isMarketFunded = function () {
  var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee9(marketDescription, configInstance) {
    var market, stage;
    return _regenerator2.default.wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            (0, _log.logInfo)('Check market already funded...');
            market = new _markets2.default(marketDescription, configInstance);
            _context9.next = 4;
            return market.getStage();

          case 4:
            stage = _context9.sent;
            return _context9.abrupt('return', stage.toNumber() === _constants.MARKET_STAGES.funded);
  ...
  return function isMarketFunded(_x16, _x17) {
...
var processArgs = function processArgs(argv) {
  ...
  var parsedArgs = void 0;

  // Arguments check
  if (argv.length === 2) {
    (0, _log.logWarn)('Running SDK Utils with default parameters');
    parsedArgs = {
      configPath: _constants.DEFAULT_CONFIG_FILE_PATH,
      marketPath: _constants.DEFAULT_MARKET_FILE_PATH
    };
  } else {
    ...
    if (argv.indexOf('-skip-fund-confirmation') > -1) {
      (0, _log.logInfo)('Asked to force funding all markets with no confirmation');
...
var runProcessStack = function () {
  var _ref10 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee10(configInstance, marketDescription, steps, step, skipFundConfirmation) {
    var marketValidator, isFunded, isResolved, x, formattedOutcome;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            isFunded = void 0, isResolved = void 0;

            // Check if the user is willing to resolve a market and if the market is already resolved

            _context10.next = 5;
            return isMarketResolved(marketDescription, configInstance);

          case 5:
            isResolved = _context10.sent;
            _context10.t0 = _regenerator2.default.keys(steps[step]);
          ...
          case 7:
            ...
            (0, _log.logInfo)('Market ' + marketDescription.marketAddress + ' looks to be resolved, skipping fund step');
            // skip
            return _context10.abrupt('continue', 7);

          case 14:
            _context10.next = 16;
            return isMarketFunded(marketDescription, configInstance);

          case 16:
            isFunded = _context10.sent;
            ...
            (0, _log.logInfo)('Market ' + marketDescription.marketAddress + ' already funded, skipping fund step');
            // skip
            return _context10.abrupt('continue', 7);
          ...
          case 30:
            (0, _log.logInfo)('Market ' + marketDescription.marketAddress + ' already resolved, skipping it');
            return _context10.abrupt('continue', 7);
          ...
          case 39:
            marketDescription = _context10.sent;
            _context10.next = 47;
            break;
          ...
          case 42:
            ...
            (0, _log.logError)(_context10.t2.message);
            throw _context10.t2;
          ...
          case 49:
            return _context10.abrupt('return', marketDescription);
    ...
    }, _callee10, undefined, [[9, 42]]);
  }));

  return function runProcessStack(_x18, _x19, _x20, _x21, _x22) {
...
var executor = function () {
  var _ref11 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee11(args, executionType, steps) {
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 45:
            ...
            _context11.next = 48;
            return (0, _rewards.claimRewards)(configInstance);
          ...
          case 50:
            _context11.prev = 50;
            _context11.t2 = _regenerator2.default.keys(marketFileCopy);
          ...
          case 52:
            ...
            x = _context11.t3.value;
            currentMarket = marketFileCopy[x];

            step = getMarketStep(currentMarket, executionType);
            _context11.next = 58;
            return runProcessStack(configInstance, currentMarket, steps, step, args.skipFundConfirmation);

          case 58:
            updatedMarket = _context11.sent;
          ...
          case 65:
            _context11.prev = 65;
            _context11.t4 = _context11['catch'](50);
    ...
    }, _callee11, undefined, [[6, 14], [30, 41], [50, 65, 69, 75]]);
  }));

  return function executor(_x23, _x24, _x25) {
