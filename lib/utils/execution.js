...
var printTokenBalance = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(configInstance) {
    var etherToken, balance, message;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            message = 'Your current collateral token balance is ' + balance + ' WETH';
...
var runProcessStack = function () {
  var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8(configInstance, marketDescription, steps, step) {
    var marketValidator, x, formattedOutcome;
...
var executor = function () {
  var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee9(args, executionType, steps) {
    var marketFile, step, configInstance, configValidator, tokenIstance, fileWriter, marketFileCopy, abort, x, currentMarket, updatedMarket;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 25:
            ...
            (0, _log.logInfo)('Wrapping ' + configInstance.amountOfTokens + ' tokens...');
            tokenIstance = new _tokens2.default(configInstance);
            _context9.next = 35;
            return tokenIstance.wrapTokens(configInstance.amountOfTokens);
    ...
    }, _callee9, undefined, [[6, 14], [30, 38], [42, 57, 61, 67]]);
  }));
