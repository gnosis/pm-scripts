...
class MarketValidator extends BaseValidator {
  ...
  */
  isValid () {
    ...
    if (!this._market.marketAddress && !this.validDate(this._market.resolutionDate)) {
      errors.push(prefix + ' ResolutionDate format is not valid, got ' + this._market.resolutionDate);
    }
